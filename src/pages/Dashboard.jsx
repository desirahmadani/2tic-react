  ...
  return (
    <div id="dashboard-container">
      ...
      <div className="flex space-x-2">
          <button className="bg-biru text-white px-4 py-2 rounded-lg">Add Button</button>
          <button className="bg-black text-white px-4 py-2 rounded-lg">Add </button>
          <button className="bg-kuning text-white px-4 py-2 rounded-lg">Back</button>
          <button className="bg-hijau text-white px-4 py-2 rounded-lg">Export</button>
        </div>
      </PageHeader>
